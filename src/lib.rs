...
mod tests {
    ...
    fn test_calculate_ref_et() {
        ...
        let output = Output::new_with_values(32.4, 10.9, None, None, None, Some(1.27), Some(22.4), Some(1.94), Some(3.0), 1462.4, 40.41_f64.to_radians(), DateTime::from_naive_utc_and_offset(naive_datetime, Utc));
